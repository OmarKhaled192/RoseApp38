...
export const remoteRoutes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            '../features/account/pages/change-password/change-password'
          ).then((m) => m.AdminChangePassword),
      },
      ...
      // Products
      {
        ...
        loadComponent: () =>
          import(
            '../features/product/component/product/product-list/product-list'
          ).then((m) => m.ProductList),
        data: {
          breadcrumbKey: 'breadcrumb.productList',
        },
      },
      {
        path: 'product/add',
        loadComponent: () =>
          import('../features/product/component/product/product').then(
            (m) => m.Product,
          ),
        data: {
          breadcrumbKey: 'breadcrumb.addProduct',
        },
      },
      {
        ...
        data: {
          breadcrumbKey: 'breadcrumb.editProduct',
        },
      },
      ...
      // Occasions
      {
        ...
        loadComponent: () =>
          import(
            '../features/occasions/components/occasion-list/occasions-list'
          ).then((m) => m.OccasionsList),
      },
      {
        path: 'occasions/add',
        loadComponent: () =>
          import(
            '../features/occasions/components/occasion-form/occasion-form'
          ).then((m) => m.OccasionForm),
        data: {
          mode: 'add',
          breadcrumb: 'add Occasion',
          breadcrumbParent: 'occasions',
        },
      },
      {
